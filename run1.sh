...
CUDA_VISIBLE_DEVICES=$1 python main.py --mask-noisy=1.0 --weight-rampup=100 --dataset=bwscifar10 --sup-batch-size=100 --usp-batch-size=100 --label-exclude=False --num-labels=400 --arch=noisyhead2 --model=inoisyheadmatch --threshold=.95 --usp-weight=1. --ema-decay=0.97 --optim=sgd --epochs=200 --lr=0.1 --momentum=0.9 --weight-decay=5e-4 --nesterov=True --lr-scheduler=cos --min-lr=1e-4 --rampup-length=80 --rampdown-length=50 --data-twice=False --save-freq=0 2>&1 | tee results/inoisyheadmatch_noisyhead2_cifar10-400_noisymask1_$(date +%y-%m-%d-%H-%M).txt
CUDA_VISIBLE_DEVICES=$1 python main.py --mask-noisy=0.3 --weight-rampup=100 --dataset=bwscifar10 --sup-batch-size=100 --usp-batch-size=100 --label-exclude=False --num-labels=400 --arch=noisyhead2 --model=inoisyheadmatch --threshold=.95 --usp-weight=1. --ema-decay=0.97 --optim=sgd --epochs=200 --lr=0.1 --momentum=0.9 --weight-decay=5e-4 --nesterov=True --lr-scheduler=cos --min-lr=1e-4 --rampup-length=80 --rampdown-length=50 --data-twice=False --save-freq=0 2>&1 | tee results/inoisyheadmatch_noisyhead2_cifar10-400_noisymask.3_$(date +%y-%m-%d-%H-%M).txt
